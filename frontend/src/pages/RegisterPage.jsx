        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center px-4 py-16 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md space-y-10 relative z-10 animate-fade-up">
                <div className="text-center flex flex-col items-center">
                    <Link to="/" className="inline-flex flex-col items-center gap-2 group select-none">
                ...
                <div className="bg-[#050505]/80 backdrop-blur-2xl border border-white/[0.05] rounded-3xl p-8 md:p-10 shadow-2xl animate-fade-up-1">
                    <form onSubmit={handleRegister} className="space-y-5">
                        <div>
                            <label className="block text-sm text-[#888] mb-2 font-medium">Full Name</label>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                {showCriteria && (
                                    <div className="absolute left-0 top-[calc(100%+12px)] w-full z-50 animate-fade-up bg-[#111]/95 backdrop-blur-xl p-4 rounded-xl border border-white/[0.1] shadow-[0_10px_40px_rgba(0,0,0,0.6)] space-y-2 pointer-events-none">
                                        {passwordCriteria.map((criterion, idx) => (
                                            <div key={idx} className="flex items-center gap-2.5 text-[13px]">
                                                {criterion.met ? (
                                                    ...
                                                    <div className="w-4 h-4 rounded-full border-[1.5px] border-[#555] flex-shrink-0" />
                                                )}
                                                <span className={criterion.met ? 'text-gray-300' : 'text-[#666]'}>
                                                    {criterion.label}
                                                </span>
                                            </div>
                                        ))}
                    ...
                    <p className="text-center text-sm text-[#888] mt-8">
                        ...
                        <Link to="/login" viewTransition className="text-white hover:text-violet-300 transition-colors font-medium">
                            Sign in
                        </Link>
                    </p>
                </div>
